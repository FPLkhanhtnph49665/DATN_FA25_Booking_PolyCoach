                ...
                <form action="{{ route('admin.users.index') }}" method="GET" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="role" class="form-select">
                            ...
                            <option value="checker" {{ request('role') == 'checker' ? 'selected' : '' }}>Kiểm soát viên
                            </option>
                        </select>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <img src="{{ $user->image ? asset($user->image) : asset('default-avatar.png') }}"
                                                alt="Avatar" class="rounded-circle border border-primary-subtle"
