                ...
                <form method="GET" action="{{ route('admin.point_fares.index') }}" class="row g-3 align-items-end">
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" name="search" id="search" value="{{ request('search') }}"
                            class="form-control" placeholder="Nhập tên điểm đón hoặc điểm trả...">
                    </div>
                    ...
                    <table class="table align-middle mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-muted small">Thuộc Tuyến</th>
                            ...
                            @forelse ($pointFares as $fare)
                                <tr>
                                    ...
                                    <td class="fw-semibold">
                                        <span
                                            class="badge bg-primary-subtle text-primary border border-primary-subtle me-2">
                                    ...
                                    <td class="text-end">
                                        ...
                                        <form action="{{ route('admin.point_fares.destroy', $fare->id) }}" method="POST"
