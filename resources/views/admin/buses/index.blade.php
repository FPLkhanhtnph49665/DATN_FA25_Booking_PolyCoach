    ...
    <div class="mb-4">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('admin.buses.create') }}" class="btn btn-primary d-flex align-items-center gap-1">
                    ...
                    <table class="table align-middle mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-muted small">Hình ảnh</th> {{-- Cột mới thêm --}}
                        ...
                        <tbody>
                            @forelse($buses as $bus)
                                <tr>
                                    ...
                                    <td>
                                        @if ($bus->images->first())
                                            <img src="{{ asset($bus->images->first()->image_path) }}" alt="Bus"
                                                class="rounded border shadow-sm"
                                                style="width: 80px; height: 50px; object-fit: cover;">
                                        @else
                                            <div class="rounded border bg-dark d-flex align-items-center justify-content-center"
